...
const minecraft_types = require('minecraft-protocol/src/datatypes/minecraft.js');
...
function write_brand(client, { brand }) {
...
function write_add_test_marker(client, marker) {
  client.write('custom_payload', {
...
function write_clear_test_markers(client) {
  client.write('custom_payload', {
...
function write_path(client, path) {
  client.write('custom_payload', {
